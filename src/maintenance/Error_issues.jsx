  ...
  return (
    <div>
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Grid>
          <Grid.Col md={1} lg={0.5} bg="red"></Grid.Col>
          <Grid.Col md={6} lg={5} bg="yellow">
          ...
          <Grid.Col md={1} lg={0} bg="pink"></Grid.Col>

          <Grid.Col md={6} lg={5} bg="blue">
          ...
          <Grid.Col md={1} lg={0.5} bg="orange"></Grid.Col>
        </Grid>
