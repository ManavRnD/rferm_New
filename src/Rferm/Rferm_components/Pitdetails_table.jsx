...
const Pitdetails_table = ({ data, columns, visibleColumns }) => {
  ...
  // Sample component to be rendered inside the modal
// const Sample = () => {
//   return (
//     <div>
     ...
     {selectedRow && (
      ...
      >
        ...
        <Paper shadow="md" radius="lg" p="xl">
            ...
            {/* For example: */}
            {/* <Text mt="xl">User ID: {selectedRow.UserID}</Text>
            <Text mt="xl">Name: {selectedRow.UserName}</Text>
            <Text mt="xl">Site Name: {selectedRow.SiteName}</Text>
            <Text mt="xl">Site Location: {selectedRow.SiteLocation}</Text> */}
...
export default Pitdetails_table;