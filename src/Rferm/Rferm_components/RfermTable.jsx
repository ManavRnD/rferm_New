...
const RfermTable = ({data}) => {
    ...
    const getPaginatedData = () => {
      ...
      const sortedData = data.slice().sort((a, b) => a[0] - b[0]); // Sort data in descending order based on row[0]
    ...
    {selectedRow && (
      ...
      >
        ...
        <Paper shadow="md" radius="lg" p="xl">
          ...
          <Text mt="xl">Alert: {selectedRow[9]}</Text> */}
          <Text mt="xl">location: {selectedRow[10]}</Text>
          <Text mt="xl">Site Name: {selectedRow[11]}</Text>
        </Paper>
